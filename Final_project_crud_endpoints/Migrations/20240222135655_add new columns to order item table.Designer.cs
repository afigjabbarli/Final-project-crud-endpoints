...
namespace Final_project_crud_endpoints.Migrations
{
    ...
    [Migration("20240222135655_add new columns to order item table")]
    partial class addnewcolumnstoorderitemtable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Final_project_crud_endpoints.DataBase.Entities.BasketItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Final_project_crud_endpoints.DataBase.Entities.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("Current_Order_Status")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Final_project_crud_endpoints.DataBase.Entities.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("Product_Size_ID")
                        .HasColumnType("uuid");

                    b.Property<Guid>("Product_Store_ID")
                        .HasColumnType("uuid");

                    b.Property<Guid>("Product_Warranty_ID")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Final_project_crud_endpoints.DataBase.Entities.Product", b =>
                {
                    ...
                    b.Property<Guid>("Current_Brand_Id")
                        .HasColumnType("uuid");

                    b.Property<Guid>("Current_Deepcategory_Id")
                        .HasColumnType("uuid");

                    b.Property<Guid>("Current_Quality_Level_Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Current_Brand_Id");

                    b.HasIndex("Current_Deepcategory_Id");
            ...
            modelBuilder.Entity("Final_project_crud_endpoints.DataBase.Entities.ProductWarranty", b =>
                {
                    ...
                    b.Property<Guid>("Warranty_Id")
                        .HasColumnType("uuid");

                    b.HasKey("Product_Id", "Warranty_Id");
            ...
            modelBuilder.Entity("Final_project_crud_endpoints.DataBase.Entities.QualityLevel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Final_project_crud_endpoints.DataBase.Entities.Warranty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Final_project_crud_endpoints.DataBase.Entities.OrderItem", b =>
                {
                    b.HasOne("Final_project_crud_endpoints.DataBase.Entities.Order", "Order")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("Final_project_crud_endpoints.DataBase.Entities.Product", b =>
                {
                    b.HasOne("Final_project_crud_endpoints.DataBase.Entities.Brand", "Brand")
                        .WithMany("Products")
                        .HasForeignKey("Current_Brand_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Final_project_crud_endpoints.DataBase.Entities.Deepcategory", "Deepcategory")
                        .WithMany("Products")
                        .HasForeignKey("Current_Deepcategory_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Final_project_crud_endpoints.DataBase.Entities.QualityLevel", "QualityLevel")
                        .WithMany("Products")
                        .HasForeignKey("Current_Quality_Level_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Brand");

                    b.Navigation("Deepcategory");
            ...
            modelBuilder.Entity("Final_project_crud_endpoints.DataBase.Entities.ProductColor", b =>
                {
                    b.HasOne("Final_project_crud_endpoints.DataBase.Entities.Color", "Color")
                        .WithMany("ProductColors")
                        .HasForeignKey("Color_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Final_project_crud_endpoints.DataBase.Entities.Product", "Product")
                        .WithMany("ProductColors")
            ...
            modelBuilder.Entity("Final_project_crud_endpoints.DataBase.Entities.ProductSize", b =>
                {
                    ...
                    b.HasOne("Final_project_crud_endpoints.DataBase.Entities.Size", "Size")
                        .WithMany("ProductSizes")
            ...
            modelBuilder.Entity("Final_project_crud_endpoints.DataBase.Entities.ProductStore", b =>
                {
                    ...
                    b.HasOne("Final_project_crud_endpoints.DataBase.Entities.Store", "Store")
                        .WithMany("ProductStores")
            ...
            modelBuilder.Entity("Final_project_crud_endpoints.DataBase.Entities.ProductWarranty", b =>
                {
                    ...
                    b.HasOne("Final_project_crud_endpoints.DataBase.Entities.Warranty", "Warranty")
                        .WithMany("ProductWarranties")
